...
const KNOWN_ERROR_CODE_PATTERN =
  /^(ORGANIZATION|PERSON|PEOPLE_INTAKE|CONTACT|ADDRESS|OBJECT|MEMBERSHIP|ACCESS|USER|AUTHENTICATION|REQUEST_CONTEXT|HTTP_SECURITY|EXTERNAL_REFERENCE|LEAD_HARVESTER_SYNC)_[A-Z0-9_]+$/u;
