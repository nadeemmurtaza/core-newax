...
function parseOptionalOAuthSecret(
  value: unknown,
  name: string,
...
function parseOptionalUrl(value: unknown, name: string, defaultValue: string): string {
  if (value === undefined) {
    return defaultValue;
  }
